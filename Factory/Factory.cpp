...
Factory::Factory(int producer_nums, FUNC producer_func, int consumer_nums, FUNC consumer_func, size_t buffer_capacity, FUNC2 buffer_func):
	buffer_(buffer_capacity, buffer_func),
